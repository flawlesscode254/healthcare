      ...
      <AnimatePresence>
        {id === activeIndex && (
          ...
          >
            ...
            Welcome to WatuWote Health, where we believe that healthcare should be accessible to all,
            regardless of financial constraints. Join our vibrant community today and unlock the benefits of
